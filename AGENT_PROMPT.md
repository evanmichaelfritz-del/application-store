...
Transitions section: essential + texts pieces, including Image generation loader. Effects section: effects pieces plus libraries.dev CLEAR (Border Beam, Gooey, Liquid metal, Thinking orbs), plus Shimmer text and Thinking Orbs playground. AI skills is empty. Graphic design / Tools empty. Manual is an add slot.
