...
export const TRANSITIONS: TransitionItem[] = [
  ...
  },
  {
    id: 'orb-solving',
    title: 'Solving',
    subtitle: '64px solving orb from the preview',
  ...
  },
  {
    id: 'orb-thinking',
    title: 'Thinking',
    subtitle: '64px Thinking ring from the preview',
    categories: ['effects', 'ai'],
  ...
  {
    id: 'orb-agent-listening',
    title: 'Agent listening',
    subtitle: '20px Agent listening chip',
    categories: ['effects', 'ai'],
  ...
  },
  {
    id: 'orb-searching',
    title: 'Searching',
    subtitle: '64px searching orb from the preview',
    categories: ['effects', 'ai'],
  ...
  {
    id: 'orb-agent-planning',
    title: 'Agent planning',
    subtitle: '20px Agent planning chip',
    categories: ['effects', 'ai'],
  ...
  {
    id: 'orb-agent-thinking',
    title: 'Agent thinking',
    subtitle: '20px Agent thinking chip',
    categories: ['effects', 'ai'],
  ...
  },
  {
    id: 'orb-working',
    title: 'Working',
    subtitle: '64px working orb from the preview',
    categories: ['effects', 'ai'],
  ...
  {
    id: 'orb-agent-shaping',
    title: 'Agent shaping',
    subtitle: '20px Agent shaping chip',
    categories: ['effects', 'ai'],
  ...
  },
  {
    id: 'preview-tools',
    title: 'Preview tools',
    subtitle: 'Drawesome pill with Agentation and grid toggles',
    categories: [],
